  ...
  return (
    <div className="w-full h-screen bg-zinc-50">
      ...
      <div className="w-full ">
        <div className="mx-10 flex gap-3 flex-col  ">
      ...
      <div className="w-full h-1/4  grid place-items-end">
        <a
          href="/next"
          className=" w-20 h-20  text-zinc-50 bg-gradient-to-r from-zinc-100 to-blue-500 text-4xl  mr-8  border-4 border-zinc-100  border-t-4 border-r-blue-400  flex items-center justify-center  rounded-full"
        >
